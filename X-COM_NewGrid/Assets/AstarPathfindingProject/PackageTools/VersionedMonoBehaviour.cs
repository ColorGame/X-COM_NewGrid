...
namespace Pathfinding {
	...
	public abstract class VersionedMonoBehaviour : MonoBehaviour, ISerializationCallbackReceiver, IVersionedMonoBehaviourInternal {
		...
		protected virtual void Awake () {
            // Убедитесь, что поле версии актуально для компонентов, созданных во время выполнения.
            // Сброс не вызывается в режиме воспроизведения.
            // Если бы данные должны были быть обновлены, то OnAfterDeserialize был бы вызван ранее.
