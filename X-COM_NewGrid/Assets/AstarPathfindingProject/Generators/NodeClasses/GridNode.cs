...
namespace Pathfinding {
    /// <summary>Узел, используемый для сеточного графика</summary>
    public class GridNode : GridNodeBase {
        ...
        /// <summary>
        /// Истинно, если узел имеет соединение в указанном направлении.
        ...
        /// <summary>
        /// Включает или отключает соединение в указанном направлении на графике.
        ...
        /// <summary>
        /// Ведется работа над функцией, для которой требовалась информация о том, какие узлы находятся на границе графика.
		...
		public override void ClearConnections (bool alsoReverse) {
			if (alsoReverse) {
                // Примечание: При этом предполагается, что все соединения являются двунаправленными
                // который должен выполняться для всех графиков сетки, если только не был добавлен какой-либо пользовательский код
                for (int i = 0; i < 8; i++) {
