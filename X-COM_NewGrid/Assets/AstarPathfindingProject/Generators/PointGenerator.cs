...
namespace Pathfinding {
	...
	public class PointGraph : NavGraph
        ...
        /// <summary>
        /// Добавьте узел к графику в указанном положении.
        /// Примечание: Vector3 может быть преобразован в Int3 с помощью (Int3)MyVector.
        ///
        /// Примечание: Это необходимо вызывать, когда обновление узлов безопасно, что является
        /// - при сканировании
        /// - во время обновления графика
        /// - внутри обратного вызова, зарегистрированного с использованием AstarPath.AddWorkItem
        ///
        /// <code>
