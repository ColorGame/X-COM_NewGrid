...
namespace Pathfinding {
	...
	public interface IAstarAI {
        ...
        /// <summary>
        /// Заполняет буфер оставшимся путем.
        ///
        /// <code>
        ...
        /// </summary>
        /// <param name="buffer">Буфер будет очищен и заменен путем. Первый пункт - это текущее положение агента.</param>
        /// <param name="stale">Может быть истинным, если путь каким-либо образом неверен. Например, если у агента нет пути или (только для сценария RichAI), если агент обнаружил, что некоторые узлы в пути были уничтожены.</param>
