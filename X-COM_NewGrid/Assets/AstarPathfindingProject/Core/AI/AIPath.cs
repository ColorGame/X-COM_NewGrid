...
namespace Pathfinding {
	...
	public partial class AIPath : AIBase, IAstarAI {
        ...
        /// <summary>
        ///  онец пути был достигнут.
        /// ≈сли вам нужна пользовательска€ логика дл€ определени€ того, когда искусственный интеллект достигнет места назначени€, добавьте ее здесь. “ы можешь
        /// также создайте новый скрипт, который наследуетс€ от этого, и переопределите функцию в этом скрипте.
        ///
        /// Ётот метод будет вызван снова, если будет вычислен новый путь, поскольку пункт назначени€, возможно, изменилс€.
        /// “аким образом, когда агент находитс€ близко к месту назначени€, этот метод обычно вызываетс€ каждый раз <see cref="repathRate"/> seconds.
        /// </summary>
