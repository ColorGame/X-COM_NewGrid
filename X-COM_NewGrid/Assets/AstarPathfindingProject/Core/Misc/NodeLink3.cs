...
namespace Pathfinding {
    ...
    /// <summary>
    /// —оедин€ет два узла треугольной сетки (графики recast /navmesh) так, как если бы у них было общее ребро.
    /// ѕримечание: ќбычно вы не хотите использовать этот тип ссылки, вы хотите использовать Node Link 2 или Node Link (извините за не очень описательные названи€).
    /// </summary>
