...
namespace Pathfinding {
    ...
    /// <summary>
    /// —оедин€ет два узла пр€мым соединением.
    /// Ќевозможно обнаружить эту ссылку при следовании по пути (который может быть хорошим или плохим), дл€ этого вы можете использовать Node Link 2.
    ///
    /// [ќткройте онлайн-документацию, чтобы просмотреть изображени€]
    ///
    /// —мотрите: редактирование-графики (рабочие ссылки смотрите в онлайн-документации)
    /// </summary>
	...
	public class NodeLink : GraphModifier {
        ...
        /// <summary>
        /// —оединение будет в этот раз проходить сложнее / медленнее.
        /// ќбратите внимание, что значени€ меньше единицы не всегда застав€т навигатор выбирать этот путь вместо другого, даже если этот должен
        /// приведет к снижению общей стоимости, если вы также не скорректируете эвристическую шкалу A* Inspector -> Settings -> Pathfinding or disable the heuristic altogether.
        /// </summary>
