...
namespace Pathfinding {
    /// <summary>Объединяет объекты path для уменьшения нагрузки на сборщик мусора</summary>
    public static class PathPool {
        ...
        /// <summary>
        /// Добавляет путь к пулу.
        /// Эта функция не должна использоваться напрямую. Instead use the Path.Claim and Path.Release functions.
        /// </summary>
        ...
        /// <summary>Получите путь из пула или создайте новый, если пул пуст</summary>
