...
namespace Pathfinding.Util {
	...
	public static class ListPool<T> {
        ...
        /// <summary>
        /// Требуйте список.
        /// Возвращает объединенный список, если таковые имеются в пуле.
        /// В противном случае он создает новый.
        /// После использования этот список должен быть выпущен с помощью функции Release (хотя это и не является строго необходимым).
        /// </summary>
