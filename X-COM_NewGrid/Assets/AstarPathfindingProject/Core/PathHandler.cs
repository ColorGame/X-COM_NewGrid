...
namespace Pathfinding {
	...
	public class PathHandler {
        ...
        /// <summary>
        ///Возвращает PathNode, соответствующий указанному узлу.
        /// PathNode специфичен для этого PathHandler, поскольку несколько PathHandlers
        /// используются одновременно, если включена многопоточность.
        /// </summary>
