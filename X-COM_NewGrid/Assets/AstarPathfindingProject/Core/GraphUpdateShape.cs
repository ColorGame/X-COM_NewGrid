...
namespace Pathfinding {
    /// <summary>
    /// Определяет форму для поиска пути.GraphUpdateОбъект.
    /// Фигура состоит из нескольких точек, для которых она может либо вычислить выпуклую оболочку, либо непосредственно использовать в качестве многоугольника.
    ///
    /// Фигура - это, по сути, двумерная фигура, однако ее можно поворачивать произвольно.
    /// Когда в конструкторе задана матрица и список точек, матрица определяет, в каком направлении
    /// - это направление "вверх". При проверке того, содержится ли точка в фигуре, точка будет спроецирована вниз
    /// на плоскости, где направление "вверх" является нормалью, и затем он проверит, содержит ли фигура точку.
    ///
