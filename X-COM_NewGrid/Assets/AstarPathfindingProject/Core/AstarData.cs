...
namespace Pathfinding {
	...
	public class AstarData {
        ...
        /// <summary>
        /// Короткий путь к первому сетчатому графику.
        /// Обновляется во время сканирования
        /// </summary>
        public GridGraph gridGraph { get; private set; }

        /// <summary>
        /// Ярлык для перехода к сетчатому графику первого слоя.
        /// Обновляется во время сканирования.
        /// </summary>
        ...
        /// <summary>
        /// Вызывает обратный вызов с каждым узлом во всех графиках.
        /// Это самый простой способ выполнить итерацию по каждому существующему узлу.
        ///
        /// <code>
        /// AstarPath.active.data.GetNodes(node => {
        ///     Debug.Log("Я нашел узел в позиции" + (Vector3)node.position);
        /// });
        /// </code>
        ///
        /// See: <see cref="Pathfinding.NavGraph.GetNodes"/> для получения узлов одного графа вместо всех.
        /// See: график-обновления (рабочие ссылки смотрите в онлайн-документации)
        /// </summary>
        ...
        /// <summary>
        /// Добавляет график типа type в массив <see cref="graphics"/>.
        /// Смотрите: графики времени выполнения (рабочие ссылки смотрите в онлайн-документации)
        /// </summary>
