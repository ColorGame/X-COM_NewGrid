...
namespace Pathfinding
{
    ...
    /// <summary>
    /// Реализует алгоритм воронки, а также различные связанные с ним методы.
    ...
    public class Funnel
    {
        /// <summary>Воронка, в которой путь к цели будет</summary>
        ...
        /// <summary>
        /// Часть пути.
        /// Это либо последовательность смежных треугольников либо ссылка.
        /// See: NodeLink2
        /// </summary>
        public struct PathPart
        {
            /// <summary>Индекс первого узла в этой части</summary>
            public int startIndex;
            /// <summary>Индекс последнего узла в этой части</summary>
            public int endIndex;
        ...
        { //Разделить на части
            ...
            // Пройдите по пути и разделите его на
            // части, соединенные ссылками
