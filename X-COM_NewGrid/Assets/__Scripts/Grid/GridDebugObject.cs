...
public class GridDebugObject : MonoBehaviour // Отладка объекта сетки (Отображение сеточных координат и список юнитов в ячейке)
{
    ...
    private object _gridObject; // Создадим переменную для хранения объекта сетки // Вместо типа GridObjectUnitXZ напишем object - Универсальный тип что бы работать с другими типами объектов
