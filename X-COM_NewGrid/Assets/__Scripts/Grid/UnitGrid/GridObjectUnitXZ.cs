                        ...
                        // GridObjectUnitXZ создается в каждой ячейки сетки. Является оболочкой для хранения Юнитов
{
    ...
    private List<Unit> _unitList; // Список юнитов. Чтобы GridObjectUnitXZ мог содержать в себе несколько юнитов
    ...
    public GridObjectUnitXZ(GridSystemXZ<GridObjectUnitXZ> gridSystem, GridPositionXZ gridPosition) // Конструктор 
    {
    ...
    public bool HasAnyUnit() //Есть ли какойнибудь юнит в данном экземпляре GridObjectUnitXZ
    {
    ...
    public Unit GetUnit()
    {
        if (HasAnyUnit()) // Если Есть какойнибудь юнит в данном экземпляре GridObjectUnitXZ
        {
