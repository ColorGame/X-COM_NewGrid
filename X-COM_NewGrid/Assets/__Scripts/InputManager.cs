...
public class InputManager : MonoBehaviour // Менеджер ввода // Все манипуляции внешних девайсов(джойстик, мышь, клавиатура...) должны проходить через этот класс
{
    ...
    public Vector2 GetMouseScreenPosition() // Вернуть положение мыши на экране (вернет значение в количестве пикселей а не в метрах)
    {
...
#else
        return Input.GetMouseButton(0); // При зажатой лев кнопки мыши вернется true в противном случае false
#endif
    }
