...
public class Testing : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        /*_gridSystemList = new GridSystem(10, 10, 2f); // построим сетку 10 на 10 и размером 2 еденицы
        _gridSystemList.CreateDebugObject(_gridDebugObjectPrefab); // Создадим наш префаб в каждой ячейки
    ...
    {
        //ТЕСТ 
        //Debug.Log(_gridSystemList.GetGridPosition(MouseWorld.GetPosition())); // Получим положение сетки прямо под мышкой
